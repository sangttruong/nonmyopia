...
from src.rank_diff_wln.nn import linearND, linear
from src.rank_diff_wln.mol_graph_direct_useScores import atom_fdim as adim, bond_fdim as bdim, max_nb, smiles2graph, smiles2graph, bond_types
from src.rank_diff_wln.models import *
...
from src.scripts.eval_by_smiles import edit_mol
...
if __name__ == '__main__':
    ...
    from src.core_wln_global.directcorefinder import DirectCoreFinder 
    from src.scripts.eval_by_smiles import edit_mol
