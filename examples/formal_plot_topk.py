...
def get_eval_list(exp_str='topk_k3', algo='hes', seed=1):
...
ax = plot_trial(exp_str='topk_k3', trial_len=40)
ax.set(ylim=[13.8, 14.75], xlabel=xlabel, ylabel=ylabel)
title = 'Alpine-3, $k = 3$'
ax.set_title(label=title, fontdict={'fontsize': 21})
ax.legend()
ax.xaxis.set_major_locator(ticker.MultipleLocator(10))
ax.yaxis.set_major_locator(ticker.MultipleLocator(0.2))
neatplot.save_figure('topk_k3', 'pdf')

ax = plot_trial(exp_str='topk_k5', trial_len=57)
ax.set(ylim=[15.3, 17.6], xlabel=xlabel, ylabel=ylabel)
title = 'Alpine-5, $k = 5$'
ax.set_title(label=title, fontdict={'fontsize': 21})
ax.xaxis.set_major_locator(ticker.MultipleLocator(10))
ax.yaxis.set_major_locator(ticker.MultipleLocator(0.5))
neatplot.save_figure('topk_k5', 'pdf')

ax = plot_trial(exp_str='topk_vacc', trial_len=60)
ax.set(ylim=[8.75, 9.4], xlabel=xlabel, ylabel=ylabel)
title = 'Vaccination, $k = 5$'
ax.set_title(label=title, fontdict={'fontsize': 21})
ax.xaxis.set_major_locator(ticker.MultipleLocator(10))
ax.yaxis.set_major_locator(ticker.MultipleLocator(0.2))
neatplot.save_figure('topk_vacc', 'pdf')
