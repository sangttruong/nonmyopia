...
plot_data_files = ['levelset_alpine_rs_seed10',
                   'levelset_alpine_us_seed10',
                   'levelset_alpine_kg_seed10',
                   'levelset_alpine_hes_seed10',
                   'levelset_alpine_gpclassifier_seed10']
...
for i, file_name in enumerate(plot_data_files):
    ...
    plot_alpine_2d(ax=ax, threshold=0.45 / alpine.y_scale)
    ...
    # Save plot and close
    neatplot.save_figure(f'{method_name[i]}_levelset_alpine', 'pdf', '/Users/lantaoyu/Desktop/ICLR22')
    plt.close()

plot_data_files = [['levelset_alpine_rs_seed10', 'levelset_alpine_rs_seed20', 'levelset_alpine_rs_seed30'],
                   ['levelset_alpine_us_seed10', 'levelset_alpine_us_seed20', 'levelset_alpine_us_seed30'],
                   ['levelset_alpine_kg_seed10', 'levelset_alpine_kg_seed20', 'levelset_alpine_kg_seed30'],
                   ['levelset_alpine_hes_seed10', 'levelset_alpine_hes_seed20', 'levelset_alpine_hes_seed30'],
                   ['levelset_alpine_gpclassifier_seed10', 'levelset_alpine_gpclassifier_seed40', 'levelset_alpine_gpclassifier_seed50']]
...
neatplot.save_figure('levelset_acc_alpine', 'pdf', '/Users/lantaoyu/Desktop/ICLR22')
