"""
Classes for synthetic functions.
"""

import numpy as np

from .gp_utils import kern_exp_quad_noard, sample_mvn, gp_post
from .domain_utils import unif_random_sample_domain

class SynthFunc:
    """Synthetic functions defined by draws from a Gaussian process."""

    def __init__(self, seed=12, hypers=None, n_obs=50, domain=None):
        """Constructor."""
        if hypers is None:
