...
from .esm import EsmModel, EsmForCausalLM
...
def load_model(
    ...
    if is_trainable and model_args.use_unsloth:
        ...
        try:
            ...
            logger.warning("Unsloth does not support model type {}.".format(
    ...
    if model is None:
        ...
        if config.model_type == "esm":
            _model: "PreTrainedModel" = EsmModel.from_pretrained(**init_kwargs)
            model: "PreTrainedModel" = EsmForCausalLM(_model, config)
        else:
