...
class DataArguments:
    ...
    cutoff_len: int = field(
        default=1024,
        metadata={
            "help": "The cutoff length of the model inputs after tokenization."},
    )
    reserved_label_len: int = field(
        default=1,
        metadata={
            "help": "The minimum cutoff length reserved for label after tokenization."},
    )
    ...
    emb_enabled: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether input is an embedding or not."},
    )
